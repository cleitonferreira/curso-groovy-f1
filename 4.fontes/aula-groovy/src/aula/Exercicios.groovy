...
// Atenção fer: não mude as classes durante as aulas pq vai quebrar outros exercícios
// faça exatamente o que ta no papel.
...
class Exercicios {
	...
	void exercicio2() {
		...
		c.setNome "Fer" // sem parênteses.
		c.setData new Date() // sem parênteses.
	...
	void exercicio11() {
		...
		println url
		// depois faça dar errado para ver o lancamento da exception
	...
	void exercicio13ponto3() {
		Pessoa p = new Pessoa()
		// O plugin de eclipse de groovy não sabe tratar trait, ele não vai ver os atributos no code completion.
		p.nome  = "Fernando"
		p.arma = "Espada"
		p.pular()
		p.falar()
	...
	void exercicio15() {
		...
		// 2) Acrescente a notação e depois executa denovo para dar true.
		println  f1.equals(f2)
	}
	...
	void exercicio29() {
		...
		def porcada  = [
			...
			gritar: {p -> println  "poorrcooooooooooo - "+ p}
		] as Torcida
	...
	void exercicio44Arquivo() {
		...
		retorno.each { println it }
		//depois altera o valor da comissão e executa denovo
	}
